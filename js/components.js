...
const Components = {
    ...
    dailyReportDetailHtml: function(report) {
        ...
        return '<h3 style="margin-bottom:14px"><i class="fas fa-calendar-day"></i> ' + (report.date ? new Date(report.date).toLocaleDateString() : 'Unknown date') + '</h3>' +
            ...
            '<div class="detail-info-grid" style="margin-top:12px"><div class="detail-info-item"><label>Puppies feeding — morning</label><p>' + ((report.puppiesFeeding && report.puppiesFeeding.morning) || 'N/A') + '</p></div><div class="detail-info-item"><label>Puppies feeding — afternoon</label><p>' + ((report.puppiesFeeding && report.puppiesFeeding.afternoon) || 'N/A') + '</p></div><div class="detail-info-item"><label>Puppies feeding — evening</label><p>' + ((report.puppiesFeeding && report.puppiesFeeding.evening) || 'N/A') + '</p></div><div class="detail-info-item"><label>Puppies feeding — night</label><p>' + ((report.puppiesFeeding && report.puppiesFeeding.night) || 'N/A') + '</p></div></div>' +
